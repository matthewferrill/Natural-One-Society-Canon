...
1. Current truth through Canon.
2. Historical context through the Vault.
...
Use Chat History when researching:
...
Use Character History when researching:
...
Use Design Decisions when researching:
...
Use Prompt Library when researching:
...
Use Retrospectives when researching:
